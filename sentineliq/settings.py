...
REST_FRAMEWORK = {
    ...
    'SCHEMA_GENERATOR_CLASS': 'api.core.openapi.SentineliqSchemaGenerator',
...
SPECTACULAR_SETTINGS = {
    ...
    'TAGS': [
        {'name': 'Authentication & Access Control', 'description': 'Endpoints for user login, JWT token handling, and RBAC access policies.'},
        {'name': 'Company Management', 'description': 'Multi-tenant company provisioning, configuration, and statistics.'},
        {'name': 'Alert Management', 'description': 'Security alert lifecycle including creation, triage, classification, and correlation.'},
        {'name': 'Incident Management', 'description': 'Case and incident tracking with escalation, investigation, and resolution workflow.'},
        {'name': 'Observables & IOCs', 'description': 'Submission, enrichment, tagging, and search of indicators of compromise.'},
        {'name': 'Threat Intelligence (SentinelVision)', 'description': 'Analyzer modules, threat feeds, and automated responders for enrichment and action.'},
        {'name': 'Notification System', 'description': 'Notification rules, delivery methods (e-mail, Slack, webhook), and logs.'},
        {'name': 'Knowledge Base (Wiki)', 'description': 'Internal documentation including runbooks, categories, and standard procedures.'},
        {'name': 'Reporting', 'description': 'Report generation in Markdown or PDF format for audit and evidence purposes.'},
        {'name': 'System Monitoring & Operations', 'description': 'Health checks, logs, background tasks, and platform-level diagnostics.'},
        {'name': 'Task Management', 'description': 'Assignment and tracking of security tasks and playbook execution.'},
        {'name': 'MITRE Framework', 'description': 'MITRE ATT&CK framework mapping and threat intelligence correlation.'},
    ],
    ...
    'SWAGGER_UI_SETTINGS': {
        ...
        'docExpansion': 'none',
        'filter': True,
        'tagsSorter': 'function(a, b) { const domainOrder = ["Authentication & Access Control", "Company Management", "Alert Management", "Incident Management", "Observables & IOCs", "Task Management", "Threat Intelligence (SentinelVision)", "MITRE Framework", "Notification System", "Knowledge Base (Wiki)", "Reporting", "System Monitoring & Operations"]; const aIndex = domainOrder.indexOf(a); const bIndex = domainOrder.indexOf(b); if (aIndex > -1 && bIndex > -1) { return aIndex - bIndex; } if (aIndex > -1) { return -1; } if (bIndex > -1) { return 1; } return a.localeCompare(b); }',
